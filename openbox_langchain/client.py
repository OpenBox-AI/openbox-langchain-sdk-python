...
from openbox_langchain.errors import OpenBoxNetworkError
...
def build_auth_headers(api_key: str) -> dict[str, str]:
    ...
    return {
        ...
        "User-Agent": f"OpenBox-LangChain-SDK/{_SDK_VERSION}",
...
class GovernanceClient:
    ...
    async def validate_api_key(self) -> None:
        ...
        """
        from openbox_langchain.errors import OpenBoxAuthError
    ...
    async def evaluate_event(
        ...
        payload["task_queue"] = event.task_queue or "langchain"
