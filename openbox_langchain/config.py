...
from openbox_langchain.types import DEFAULT_HITL_CONFIG, HITLConfig
...
def merge_config(partial: dict[str, Any] | None = None) -> GovernanceConfig:
    ...
    return GovernanceConfig(
        ...
        task_queue=partial.get("task_queue", "langchain"),
...
def initialize(
    ...
    """Initialize the OpenBox LangChain SDK with credentials.
    ...
    _get_logger().info(f"OpenBox LangChain SDK initialized with API URL: {api_url}")
